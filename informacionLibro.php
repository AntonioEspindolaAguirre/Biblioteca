...
<div class="container">
	<div class="row">
      ...
      echo "<td>" .$fila[2]. "</td>";
     	...
     	echo "<td align='center'><a href='actualizarLibro.php?clave=".$fila[0]."&opcion=3'> <i class='fa fa-pencil' style='font-size:24px'></a></i></td>"; 
 		echo "<td><a href='metodosLibro.php?clave=".$fila[0]." &opcion=4'><i class='fa fa-trash-o'style='font-size:24px; color:red'></i></a></td></tr>";
         }
