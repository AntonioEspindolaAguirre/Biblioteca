...
<div class="container">
	<div class="row">
		...
		<br>
		<p align="right">                             
         <button class="btn btn-primary" onclick="location.href='agregarEditorial.php'">Agregar Editorial </button> </p>
      ...
      echo "<td>" .$fila[0]. "</td>";
     	...
     	echo "<td align='center'><a href='actualizarEditorial.php?correo=".$fila[2]."'> <i class='fa fa-pencil' style='font-size:24px'></a></i></td>"; 
 		echo "<td><a href='metodosEditorial.php?correo=".$fila[2]." &opcion=4'><i class='fa fa-trash-o'style='font-size:24px; color:red'></i></a></td></tr>";
         }
...
header('Location:informacionEditorial.php');
?>