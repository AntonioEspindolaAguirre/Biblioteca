        ...
        <nav class="navbar navbar-expand-md  navbar navbar-light lead" style="background-color: #e3f2fd;"> 
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0" method="POST" >
             <!-- <input class="form-control mr-sm-2" type="search" placeholder="Omar" name="nomAu" aria-label="Buscar" required>-->
             <?php
                    ...
                    ?>
              <button class="btn btn-outline-success my-2 ml-1 my-sm-0" type="submit" >Buscar</button>
            </form>
          </div>
        </nav>
      </div>
    ...
    <div class="row">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                if($fila=mysqli_fetch_array($nulo)){
                    ...
                    echo"</tr>";
                    echo"</thead>";
                    While($validar =mysqli_fetch_array($libro))
                    {
                    ...
                    echo "<td>".$validar['6']."</td></tr>";
                        ...
                        mensage('Editorial sin libro','buscarEditorial.php','error.png');
