...
<header>
 ...
 <div class="container">
 	<div class="row">
         ...
         <h1 align="center"> Ver informacion del usuario </h1> 
         <br>
         ...
         <?php 
            ...
            $consulta=$conexion->query($sql);              
                if($fila =mysqli_fetch_array($consulta)){
                  echo"<h3> Nombre:".$fila[1]. "</h3>";
                  echo"<h3> Apellido paterno:".$fila[2]. "</h3>";
                  echo"<h3> Apellido materno:".$fila[3]. "</h3>";
                  echo"<h3> Fecha de registro:".$fila[4]. "</h3>";
                  echo"<h3> Telefono:".$fila[5]. "</h3>";
                  echo"<h3> Email:".$fila[7]. "</h3>";
